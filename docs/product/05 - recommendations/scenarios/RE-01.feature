Feature: RE-01 — Seed Selection Logic
  ...
  Scenario: RE-01-01 — Prioritizing rated entries for recommendation seeds
  ...
  Scenario: RE-01-02 — Sorting unrated items by recency
  ...
  Scenario: RE-01-03 — Handling small library with fewer than 5 entries
