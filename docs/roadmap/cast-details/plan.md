...
- [ ] **9.1** Update locale-key tests to require the new person keys in `en.json`, `es.json`, and `fr.json`:
...
- [ ] **9.2** Run `npm run test -- tests/presentation/i18n/locale-keys.test.ts` and confirm the locale-key tests fail before implementation.

- [ ] **9.3** Add all person keys to `src/presentation/i18n/locales/en.json`, `es.json`, and `fr.json`; rerun locale-key tests.

## Phase 10: Presentation Testing

- [ ] **10.1** Create component tests for person detail components, mocking only Application-facing data shapes:
...
- [ ] **10.2** Create `tests/presentation/views/person-screen.test.ts`, mocking `usePerson()` and `useToast()`:
...
- [ ] **10.3** Run `npm run test -- tests/presentation/components/details/person-hero.test.ts tests/presentation/components/details/person-bio.test.ts tests/presentation/components/details/person-links.test.ts tests/presentation/components/details/filmography-card.test.ts tests/presentation/views/person-screen.test.ts` and confirm the new tests fail before implementation.

## Phase 11: Presentation Components and View

- [ ] **11.1** Create `src/presentation/components/details/person-hero.vue`:
...
- [ ] **11.2** Create `src/presentation/components/details/person-bio.vue`:
...
- [ ] **11.3** Create `src/presentation/components/details/person-info.vue`:
...
- [ ] **11.4** Create `src/presentation/components/details/person-links.vue`:
...
- [ ] **11.5** Create `src/presentation/components/details/filmography-card.vue`:
...
- [ ] **11.6** Create `src/presentation/components/details/filmography-grid.vue`:
...
- [ ] **11.7** Create `src/presentation/components/details/person-skeleton.vue`:
...
- [ ] **11.8** Create `src/presentation/views/person-screen.vue`:
...
- [ ] **12.1** Update `tests/presentation/components/details/cast-carousel.test.ts`:
...
- [ ] **12.2** Run `npm run test -- tests/presentation/components/details/cast-carousel.test.ts` and confirm the new tests fail before implementation.

## Phase 13: CastCarousel Update

- [ ] **13.1** Update `src/presentation/components/details/cast-carousel.vue`:
...
- [ ] **13.2** Run `npm run test -- tests/presentation/components/details/cast-carousel.test.ts`; CastCarousel tests should pass.
...
- [ ] **14.4** Review `docs/product/02 - home/requirements.md` and update only if its detail-page navigation text needs a cross-reference to person pages; confirm `HS-03` still filters person search results out.

- [ ] **14.5** Update `docs/reference/glossary.md` with Person, Cast member, and Filmography terms, or align these terms with existing glossary entries if equivalent terms already exist.
