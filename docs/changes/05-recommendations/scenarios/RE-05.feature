Feature: RE-05 — Labeled Sections
  ...
  Scenario: SC-RE-05-01 — Displaying "Because you liked" label for high ratings
  ...
  Scenario: SC-RE-05-02 — Displaying "Because you watched" label for low ratings
    Given a movie seed "The Room" with a rating of 1 star
    When the recommendations are displayed on the Recommendations screen
    Then the carousel section label SHALL be "Because you watched The Room"

  Scenario: SC-RE-05-03 — Displaying "Because you watched" label for unrated seeds
