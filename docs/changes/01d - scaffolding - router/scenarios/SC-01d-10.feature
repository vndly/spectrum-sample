Feature: SC-01d-10 — Document title
  The document title SHALL update to reflect the current page.

  Scenario: SC-01d-10-01 — Title updates on navigation
  ...
  Scenario: SC-01d-10-02 — Title uses i18n in non-default locale
  ...
  Scenario: SC-01d-10-03 — Home route title
    Given the app is running
    When I navigate to /
