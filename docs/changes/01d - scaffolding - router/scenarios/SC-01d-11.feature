Feature: SC-01d-11 — Scroll-to-top
  The page SHALL scroll to the top on every navigation.

  Scenario: SC-01d-11-01 — Scroll resets on forward navigation
  ...
  Scenario: SC-01d-11-02 — Scroll resets on browser back navigation
