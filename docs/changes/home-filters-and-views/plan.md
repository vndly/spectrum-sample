...
2.  [ ] **Testing: Filtering Logic (Component/Integration)**
    ...
    - *Covering: HF-01, HF-02, HF-03, HF-09*
...
1.  [ ] **Integration into Home Screen**
    ...
    - Apply filters to `TrendingCarousel` and `PopularGrid` results.
    - **Logic:** Reset filters when `searchQuery` becomes non-empty (Search Mode).
    - *Covering: HF-04, HF-05, HF-09*
